#!/usr/bin/env python3
"""Prepare a fresh registered full C1 GRPO-Default run."""
...
def main() -> None:
    ...
    lines = [
        "# C1 GRPO-Default Full Run Metadata", "",
        ...
        "- PPO epochs: 1", "- KL loss coefficient: 0.02", "- Rank penalty: 0.0",
        "- Hard blocking: disabled",
        "- Resume: disabled; optimizer and rollout buffer start fresh",
        "- Classification: registered full C1 seed-42 run",

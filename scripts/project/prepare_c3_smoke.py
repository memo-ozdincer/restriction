#!/usr/bin/env python3
"""Create a fresh one-update C3 HardBlock-Restart engineering smoke run."""
...
def main() -> None:
    ...
    if "split" not in frame.columns or "theorem_full_name" not in frame.columns:
        parser.error("registered source lacks split or theorem identity")
